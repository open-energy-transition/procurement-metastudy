##########################################
Procurement Configuration (Under Construction)
##########################################
...
.. note::
   ...
   1. `scenarios.form.yaml <https://open-energy-transition.github.io/procurement-metastudy/12-scenarios.html>`_
   2. config.form.yaml (**this section**)
   3. `config.default.yaml <https://pypsa-eur.readthedocs.io/en/latest/configuration.html>`_
   4. `config.kpi.yaml <https://open-energy-transition.github.io/procurement-metastudy/13-kpis.html>`_
...
This means that the total budget is 315.4 MtCO2, equivalent to 10.7% of 1990 emissions for this scope. The complete calculation can be seen in the `Carbon Emission Calculation <https://open-energy-transition.github.io/procurement-metastudy/22-co2_calculation.html>`_ section.

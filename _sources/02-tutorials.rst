...
The content of ``baseline-mds`` as well as a comprehensive list of all studied scenarios is defined in ``scenarios.form.yaml`` as described in `Scenarios Configuration <https://open-energy-transition.github.io/procurement-metastudy/12-scenarios.html>`_.
...
.. note::
   ...
   * ``100H``: significantly quicker to solve compared to ``1H``
   ...
   See `Segmentation Temporal Clustering <https://open-energy-transition.github.io/procurement-metastudy/21-segmentation.html>`_ for more details
...
* By analyzing the PyPSA network directly, see `Package_unpackage_networks.ipynb <https://github.com/open-energy-transition/procurement-metastudy/tree/master/notebooks/Package_unpackage_networks.ipynb>`_ for more details.
...
The automatic generation of KPI plots is a feature from this project and may be upstreamed in the future. To create your own custom KPI plots, see `KPI Configuration <https://open-energy-transition.github.io/procurement-metastudy/13-kpis.html>`_
